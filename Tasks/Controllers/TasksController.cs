...
namespace Tasks.Controllers
{
    public class TasksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TaskName,TaskDescription,Start,End")] Task task)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TaskName,TaskDescription,Start,End")] Task task)
        {
            if (id != task.Id)
            {
                return NotFound();
